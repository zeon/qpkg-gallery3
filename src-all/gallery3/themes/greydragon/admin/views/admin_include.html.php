...
#g-content form ul li select { display: inline; float: left; margin-right: 0.8em; width: 51%; padding: 0 0 0 .2em; }
  ...
  <div id="gd-admin-head">
    ...
    <div id="gd-admin-hlinks">
      <ul><li><a href="http://blog.dragonsoft.us/gallery-3/" target="_blank"><?= t("Home") ?></a>&nbsp;|&nbsp;</li>
        ...
        <li><a href="<?= $admin_link_download; ?>" target="_blank"><?= t("Download") ?></a>&nbsp;|&nbsp;</li>
        <? if ($admin_link_vote): ?>
        <li><a href="<?= $admin_link_vote;     ?>" target="_blank"><?= t("Vote") ?></a>&nbsp;|&nbsp;</li>
        <? endif; ?>
