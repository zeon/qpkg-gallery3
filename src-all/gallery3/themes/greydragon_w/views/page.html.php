...
<!-- Grey Dragon Wind Theme - Copyright (c) 2010 Serguei Dosyukov - All Rights Reserved -->
  ...
  <div id="doc4" class="yui-t5 g-view">
    ...
    <div id="g-footer" class="ui-helper-clearfix">
      ...
      <?php
        ...
        print "\n    <li>" . $theme_info->name . " " . t("v.") . $theme_info->version . "</li>";
        print "\n    <li>&copy;" . $theme_info->author . "</li>";
      ?>
      </ul>
      <? endif ?>
      <div id="g-footer-rightside"><?= $theme->copyright ?>
      </div>
    </div>
  </div>
  <?= $theme->page_bottom() ?>
